...
var ASM_CONSTS = {
  71536: ($0) => { try { return FS.analyzePath(UTF8ToString($0)).exists; } catch(e){ return 0; } },  
 71618: ($0) => { try { return FS.analyzePath(UTF8ToString($0)).object.isFolder; } catch(e){ return 0; } },  
 71709: ($0) => { try { FS.mkdir(UTF8ToString($0)); } catch(e){ console.log(e); } },  
 71777: ($0) => { try { FS.rmdir(UTF8ToString($0)); } catch(e){ console.log(e); } },  
 71845: ($0) => { try { FS.unlink(UTF8ToString($0)); } catch(e){ console.log(e); } },  
 71914: ($0, $1) => { var x = $0; var y = $1; if(document.pointerLockElement === Module['canvas']){ } else { } },  
 72007: () => { var canvas = Module['canvas']; canvas.style.cursor = 'none'; },  
 72072: () => { var canvas = Module['canvas']; canvas.style.cursor = 'default'; },  
 ...
 72529: ($0) => { if (navigator.clipboard) { var text = UTF8ToString($0); navigator.clipboard.writeText(text); } else { console.log("Clipboard API not available"); } }
};
